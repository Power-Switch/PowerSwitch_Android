...
package eu.power_switch.obj.device.pollin_electronic;
...
import eu.power_switch.obj.receiver.device.pollin_electronic.Set2605;
...
public class Set2605_Test extends ReceiverTest {
    ...
    public void testCodeGeneration0000000000() throws Exception {
        ...
        receiver = new Set2605(getContext(), (long) 0, "Name", dips, (long) 0);
