...
package eu.power_switch.obj.device.vivanco;
...
import eu.power_switch.obj.receiver.device.vivanco.FSS33600W;

/**
 * Created by Markus on 08.08.2015.
 */
public class FSS33600W_Test extends ReceiverTest {

    private static FSS33600W receiver;
    ...
    public void testCodeGeneration0000000000() throws Exception {
        ...
        receiver = new FSS33600W(getContext(), (long) 0, "Name", dips, (long) 0, new ArrayList<Gateway>());
