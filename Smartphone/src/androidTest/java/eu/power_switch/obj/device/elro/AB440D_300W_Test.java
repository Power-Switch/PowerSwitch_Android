...
import eu.power_switch.obj.receiver.device.elro.AB440D_300W;

/**
 * Created by Markus on 08.08.2015.
 */
public class AB440D_300W_Test extends ReceiverTest {

    private static AB440D_300W receiver;
    ...
    public void testCodeGeneration0000000000() throws Exception {
        ...
        receiver = new AB440D_300W(getContext(), (long) 0, "Name", dips, (long) 0, new ArrayList<Gateway>());
