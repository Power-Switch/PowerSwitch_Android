...
import eu.power_switch.obj.receiver.device.brennenstuhl.RCS1000NComfort;

/**
 * Created by Markus on 08.08.2015.
 */
public class RCS1000NComfort_Test extends ReceiverTest {

    private static RCS1000NComfort receiver;
    ...
    public void testCodeGeneration0000000000() throws Exception {
        ...
        receiver = new RCS1000NComfort(getContext(), (long) 0, "Name", dips, (long) 0, new ArrayList<Gateway>());
