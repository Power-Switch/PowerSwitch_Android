...
import eu.power_switch.obj.receiver.device.intertechno.ITR1500;

/**
 * Created by Markus on 08.08.2015.
 */
public class ITR1500_Test extends ReceiverTest {

    private ITR1500 receiver;

    @Test
    public void testCodeGenerationA1() throws Exception {
        receiver = new ITR1500(getContext(), (long) 0, "Name", 'A', 1, (long) 0, new ArrayList<Gateway>());
    ...
    public void testCodeGenerationA5() throws Exception {
        receiver = new ITR1500(getContext(), (long) 0, "Name", 'A', 5, (long) 0, new ArrayList<Gateway>());
    ...
    public void testCodeGenerationE1() throws Exception {
        receiver = new ITR1500(getContext(), (long) 0, "Name", 'E', 1, (long) 0, new ArrayList<Gateway>());
    ...
    public void testCodeGenerationP16() throws Exception {
        receiver = new ITR1500(getContext(), (long) 0, "Name", 'P', 16, (long) 0, new ArrayList<Gateway>());
