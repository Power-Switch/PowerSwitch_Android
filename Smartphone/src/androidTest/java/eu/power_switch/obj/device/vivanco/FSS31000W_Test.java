...
import eu.power_switch.obj.receiver.device.vivanco.FSS31000W;

/**
 * Created by Markus on 08.08.2015.
 */
public class FSS31000W_Test extends ReceiverTest {

    private static FSS31000W receiver;
    ...
    public void testCodeGeneration0000000000() throws Exception {
        ...
        receiver = new FSS31000W(getContext(), (long) 0, "Name", dips, (long) 0, new ArrayList<Gateway>());
