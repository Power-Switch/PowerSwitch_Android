...
import eu.power_switch.obj.receiver.device.elro.AB440WD;

/**
 * Created by Markus on 08.08.2015.
 */
public class AB440WD_Test extends ReceiverTest {

    private static AB440WD receiver;
    ...
    public void testCodeGeneration0000000000() throws Exception {
        ...
        receiver = new AB440WD(getContext(), (long) 0, "Name", dips, (long) 0, new ArrayList<Gateway>());
