...
import eu.power_switch.obj.receiver.device.intertechno.YCR1000;

/**
 * Created by Markus on 08.08.2015.
 */
public class YCR1000_Test extends ReceiverTest {

    private YCR1000 receiver;

    @Test
    public void testCodeGenerationA1() throws Exception {
        receiver = new YCR1000(getContext(), (long) 0, "Name", 'A', 1, (long) 0, new ArrayList<Gateway>());
    ...
    public void testCodeGenerationA5() throws Exception {
        receiver = new YCR1000(getContext(), (long) 0, "Name", 'A', 5, (long) 0, new ArrayList<Gateway>());
    ...
    public void testCodeGenerationE1() throws Exception {
        receiver = new YCR1000(getContext(), (long) 0, "Name", 'E', 1, (long) 0, new ArrayList<Gateway>());
    ...
    public void testCodeGenerationP16() throws Exception {
        receiver = new YCR1000(getContext(), (long) 0, "Name", 'P', 16, (long) 0, new ArrayList<Gateway>());
