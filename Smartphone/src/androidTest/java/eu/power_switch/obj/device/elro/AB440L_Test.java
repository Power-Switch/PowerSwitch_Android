...
import eu.power_switch.obj.receiver.device.elro.AB440L;

/**
 * Created by Markus on 08.08.2015.
 */
public class AB440L_Test extends ReceiverTest {

    private static AB440L receiver;
    ...
    public void testCodeGeneration0000000000() throws Exception {
        ...
        receiver = new AB440L(getContext(), (long) 0, "Name", dips, (long) 0, new ArrayList<Gateway>());
