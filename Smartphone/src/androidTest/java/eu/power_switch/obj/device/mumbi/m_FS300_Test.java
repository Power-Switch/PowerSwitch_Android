...
package eu.power_switch.obj.device.mumbi;
...
import eu.power_switch.obj.receiver.device.mumbi.m_FS300;

/**
 * Created by Markus on 08.08.2015.
 */
public class m_FS300_Test extends ReceiverTest {

    private static m_FS300 receiver;
    ...
    public void testCodeGeneration0000000000() throws Exception {
        ...
        receiver = new m_FS300(getContext(), (long) 0, "Name", dips, (long) 0, new ArrayList<Gateway>());
