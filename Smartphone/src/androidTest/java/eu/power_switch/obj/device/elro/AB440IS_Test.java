...
import eu.power_switch.obj.receiver.device.elro.AB440IS;

/**
 * Created by Markus on 08.08.2015.
 */
public class AB440IS_Test extends ReceiverTest {

    private static AB440IS receiver;
    ...
    public void testCodeGeneration00000000() throws Exception {
        ...
        receiver = new AB440IS(getContext(), (long) 0, "Name", dips, (long) 0, new ArrayList<Gateway>());
