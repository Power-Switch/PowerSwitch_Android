...
package eu.power_switch.database.receivers;

import org.junit.Test;

import java.util.LinkedList;

import eu.power_switch.database.DatabaseTest;
...
public class ReceiverReflectionMagicTest extends DatabaseTest {
    ...
    public void testGetDummyMasterSlave() throws Exception {
        Receiver dummy = ReceiverReflectionMagic.getDummy(getContext(), "eu.power_switch.obj.receiver.device.intertechno" +
                ".CMR1000");
    ...
    public void testGetDummyDips() throws Exception {
        Receiver dummy = ReceiverReflectionMagic.getDummy(getContext(), "eu.power_switch.obj.receiver.device.brennenstuhl.RCS1000NComfort");
    ...
    public void testGetDummyAutoPair() throws Exception {
        Receiver dummy = ReceiverReflectionMagic.getDummy(getContext(), "eu.power_switch.obj.receiver.device.brennenstuhl.RC3600");
        assertEquals((long) 0, (long) dummy.getId());
        assertEquals("dummy", dummy.getName());
        assertEquals(null, dummy.getRoomId());
    }
    ...
    public void testGetDummyUniversal() throws Exception {
        Receiver dummy = ReceiverReflectionMagic.getDummy(getContext(), "eu.power_switch.obj.receiver.UniversalReceiver");
