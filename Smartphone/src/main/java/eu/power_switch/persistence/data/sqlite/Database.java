...
package eu.power_switch.persistence.data.sqlite;
...
import eu.power_switch.persistence.data.sqlite.table.apartment.ApartmentGatewayRelationTable;
...
import eu.power_switch.persistence.data.sqlite.table.gateway.GatewaySsidTable;
import eu.power_switch.persistence.data.sqlite.table.gateway.GatewayTable;
...
import eu.power_switch.persistence.data.sqlite.table.history.HistoryTable;
import eu.power_switch.persistence.data.sqlite.table.receiver.AutoPairTable;
import eu.power_switch.persistence.data.sqlite.table.receiver.DipTable;
import eu.power_switch.persistence.data.sqlite.table.receiver.MasterSlaveTable;
import eu.power_switch.persistence.data.sqlite.table.receiver.ReceiverGatewayRelationTable;
import eu.power_switch.persistence.data.sqlite.table.receiver.ReceiverTable;
import eu.power_switch.persistence.data.sqlite.table.receiver.UniversalButtonTable;
import eu.power_switch.persistence.data.sqlite.table.room.RoomGatewayRelationTable;
import eu.power_switch.persistence.data.sqlite.table.room.RoomTable;
import eu.power_switch.persistence.data.sqlite.table.scene.SceneItemTable;
...
import eu.power_switch.persistence.data.sqlite.table.timer.TimerTable;
import eu.power_switch.persistence.data.sqlite.table.timer.TimerWeekdayTable;
import eu.power_switch.persistence.data.sqlite.table.widget.ReceiverWidgetTable;
import eu.power_switch.persistence.data.sqlite.table.widget.RoomWidgetTable;
import eu.power_switch.persistence.data.sqlite.table.widget.SceneWidgetTable;
