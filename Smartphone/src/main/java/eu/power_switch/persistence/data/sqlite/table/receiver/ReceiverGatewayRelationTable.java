...
public class ReceiverGatewayRelationTable {
    ...
    public static final String TABLE_NAME = "receiver_gateway_relation";
    public static final String COLUMN_RECEIVER_ID = "receiver_id";
    public static final String COLUMN_GATEWAY_ID = "gateway_id";

    public static final String[] ALL_COLUMNS = {COLUMN_RECEIVER_ID, COLUMN_GATEWAY_ID};
    ...
    private static final String TABLE_CREATE = "CREATE TABLE " + TABLE_NAME + "(" +
            ...
            "PRIMARY KEY (" + COLUMN_RECEIVER_ID + ", " + COLUMN_GATEWAY_ID + ")" +
            ");";
    //@formatter:on
