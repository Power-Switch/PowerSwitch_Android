...
public class HolidaySpecialHandler {
     ...
     */
    public void showHolidaySpecial() {
        ...
        } else if (easterDate.get(Calendar.MONTH) == currentDate.get(Calendar.MONTH) && easterDate.get(Calendar.DAY_OF_MONTH) == currentDate.get(
