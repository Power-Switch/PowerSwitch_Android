...
public class ClipboardHandler {
     ...
     */
    public void copyToClipboard(@StringRes int label, @StringRes int content) {
        copyToClipboard(context.getString(label), context.getString(content));
    }
    ...
    public void copyToClipboard(String label, String content) {
        ...
        if (sdk < android.os.Build.VERSION_CODES.HONEYCOMB) {
            @SuppressWarnings("deprecation") android.text.ClipboardManager clipboard = (android.text.ClipboardManager) context.getSystemService(
     ...
     */
    public String getClipboardContent() throws EmptyClipboardException {
        ClipboardManager clipboard = (ClipboardManager) context.getSystemService(Context.CLIPBOARD_SERVICE);
