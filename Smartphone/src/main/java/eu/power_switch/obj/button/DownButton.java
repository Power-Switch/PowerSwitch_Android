...
public class DownButton extends Button {
     ...
     * ID of this Button
     */
    public static final long ID = DatabaseConstants.BUTTON_DOWN_ID;
     ...
     */
    public DownButton(Context context, Long receiverId) {
        super(ID, context.getString(R.string.down), receiverId);
    }
}
