...
public class AB440WD extends Receiver implements DipReceiver {
    // dips are 12345 ABCDE

    static Brand  BRAND = Brand.ELRO;
    static String MODEL = Receiver.getModelName(AB440WD.class.getCanonicalName());
    ...
    public AB440WD(Context context, Long id, String name, LinkedList<Boolean> dips, Long roomId, List<Gateway> associatedGateways) {
