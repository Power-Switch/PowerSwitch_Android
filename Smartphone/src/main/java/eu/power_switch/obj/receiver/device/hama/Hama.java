...
package eu.power_switch.obj.receiver.device.hama;
...
public class Hama extends Receiver implements AutoPairReceiver {
    ...
    static String BRAND = Receiver.BRAND_HAMA;
    static String MODEL = Receiver.getModelName(Hama.class.getCanonicalName());
    ...
    public Hama(Context context, Long id, String name, long seed, Long roomId) {
