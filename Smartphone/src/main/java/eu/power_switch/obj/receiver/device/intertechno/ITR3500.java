...
public class ITR3500 extends CMR1000 implements MasterSlaveReceiver {

    private static final String MODEL = Receiver.getModelName(ITR3500.class.getCanonicalName());

    public ITR3500(Context context, Long id, String name, char channelMaster, int channelSlave, Long roomId, List<Gateway> associatedGateways) {
