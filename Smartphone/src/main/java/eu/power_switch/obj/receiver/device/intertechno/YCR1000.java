...
public class YCR1000 extends CMR1000 implements MasterSlaveReceiver {
    ...
    private static final String MODEL = Receiver.getModelName(YCR1000.class.getCanonicalName());

    public YCR1000(Context context, Long id, String name, char channelMaster, int channelSlave, Long roomId, List<Gateway> associatedGateways) {
