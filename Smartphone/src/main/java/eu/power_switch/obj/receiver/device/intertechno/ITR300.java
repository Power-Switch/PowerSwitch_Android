...
public class ITR300 extends CMR1000 implements MasterSlaveReceiver {

    private static final String MODEL = Receiver.getModelName(ITR300.class.getCanonicalName());

    public ITR300(Context context, Long id, String name, char channelMaster, int channelSlave, Long roomId, List<Gateway> associatedGateways) {
