...
import eu.power_switch.obj.button.DownButton;
import eu.power_switch.obj.button.StopButton;
...
public class RMF_R1 extends Receiver implements AutoPairReceiver {
    ...
    public RMF_R1(Context context, Long id, String name, long seed, Long roomId, List<Gateway> associatedGateways) {
