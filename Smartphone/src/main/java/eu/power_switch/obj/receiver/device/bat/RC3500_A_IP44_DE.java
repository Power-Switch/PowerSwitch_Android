...
public class RC3500_A_IP44_DE extends Receiver implements DipReceiver {
    ...
    static String MODEL = Receiver.getModelName(RC3500_A_IP44_DE.class.getCanonicalName());
    ...
    public RC3500_A_IP44_DE(Context context, Long id, String name, LinkedList<Boolean> dips, Long roomId) {
