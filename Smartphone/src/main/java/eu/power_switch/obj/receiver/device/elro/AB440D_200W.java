...
public class AB440D_200W extends Receiver implements DipReceiver {
    // dips are 12345 ABCDE

    private static final String BRAND = Receiver.BRAND_ELRO;
    private static final String MODEL = Receiver.getModelName(AB440D_200W.class.getCanonicalName());
