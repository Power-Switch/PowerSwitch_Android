...
public class PAR_1500 extends CMR1000 implements MasterSlaveReceiver {

    private static final String MODEL = Receiver.getModelName(PAR_1500.class.getCanonicalName());

    public PAR_1500(Context context, Long id, String name, char channelMaster, int channelSlave, Long roomId, List<Gateway> associatedGateways) {
