        ...
        try {
            if (message.startsWith("HCGW:")) {
                ...
                if (brand.contains("Simple Solutions") || model.contains("ConnAir")) {
                    return new ConnAir(0, true, "AutoDiscovered", firmware, host, 49880);
                }
                ...
                if (brand.contains("Brennenstuhl") || model.contains("0290217")) {
                    return new BrematicGWY433(0, true, "AutoDiscovered", firmware, host, 49880);
                }
                ...
                if (brand.contains("ITECHNO") && (model.contains("HCGW22") || model.contains("ITGW-433"))) {
                    return new ITGW433(0, true, "AutoDiscovered", firmware, host, 49880);
                }
            }
            return null;
        } catch (Exception e) {
