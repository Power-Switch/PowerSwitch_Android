...
/**
 * Fragment containing a List of all Geofences
 */
public class GeofencesFragment extends RecyclerViewFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        rootView = inflater.inflate(R.layout.fragment_geofences, container, false);
...
//        }
    ...
    private void fillListWithGeofences() {
        try {
            geofences.addAll(DatabaseHandler.getAllGeofences());
        } catch (Exception e) {
            Log.e(e);
