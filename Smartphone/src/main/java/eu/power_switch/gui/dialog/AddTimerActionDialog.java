 ...
 */
public class AddTimerActionDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        rootView = inflater.inflate(R.layout.dialog_add_timer_action, null);
        ...
        builder.setTitle(R.string.add_timer_action);
        builder.setPositiveButton(R.string.add, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                addCurrentSelection();
                sendTimerActionAddedBroadcast(getContext());
            }
        });
